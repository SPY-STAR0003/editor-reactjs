export const AlignLeft = ({classes, ...props}) => {
    return (
...
export const Strike = ({classes, ...props}) => {
    return (
        <svg {...props} className={`${classes ?? "fill-gray-400"} small-tiptap-btn tiptap-keyboard-menu-btn `} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
...
export const Code = ({classes, ...props}) => {
    return (
        <svg {...props} className={`${classes ?? "fill-gray-400"} small-tiptap-btn tiptap-keyboard-menu-btn`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
export const DeleteMark = ({classes, ...props}) => {
    return (
        <svg {...props} className={`${classes ?? "fill-gray-400"} small-tiptap-btn tiptap-keyboard-menu-btn`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
export const ChevronTop = ({classes, ...props}) => {
    return (
        <svg {...props} className={`${classes ?? "fill-gray-400"} small-tiptap-btn tiptap-keyboard-menu-btn`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
export const Tick = ({classes, ...props}) => {
    return (
        <svg {...props} className={`${classes ?? "fill-gray-400"} small-tiptap-btn tiptap-keyboard-menu-btn`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
export const BulletList = ({classes, ...props}) => {
    return (
        <svg {...props} className={`${classes ?? "fill-gray-400"} small-tiptap-btn tiptap-keyboard-menu-btn`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
export const OrderedList = ({classes, ...props}) => {
    return (
        <svg {...props} className={`${classes ?? "fill-gray-400"} small-tiptap-btn tiptap-keyboard-menu-btn`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
export const BlackCode = ({classes, ...props}) => {
    return (
        <svg {...props} className={`${classes ?? "fill-gray-400"} small-tiptap-btn tiptap-keyboard-menu-btn`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
export const BlockQoute = ({classes, ...props}) => {
    return (
        <svg {...props} className={`${classes ?? "fill-gray-400"} small-tiptap-btn tiptap-keyboard-menu-btn`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
export const Line = ({classes, ...props}) => {
    return (
        <svg {...props} className={`${classes ?? "fill-gray-400"} small-tiptap-btn tiptap-keyboard-menu-btn`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
export const Undo = ({classes, ...props}) => {
    return (
        <svg {...props} className={`${classes ?? "fill-gray-400"} small-tiptap-btn tiptap-keyboard-menu-btn`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
...
export const Redu = ({classes, ...props}) => {
    return (
        <svg {...props} className={`${classes ?? "fill-gray-400"} small-tiptap-btn tiptap-keyboard-menu-btn`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
...
export const LeftAlign = ({classes, ...props}) => {
    return (
        <svg {...props} className={`${classes ?? "fill-gray-400"} small-tiptap-btn tiptap-keyboard-menu-btn`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <path d="M3,7H21a1,1,0,0,0,0-2H3A1,1,0,0,0,3,7Zm0,4H17a1,1,0,0,0,0-2H3a1,1,0,0,0,0,2Zm18,2H3a1,1,0,0,0,0,2H21a1,1,0,0,0,0-2Zm-4,4H3a1,1,0,0,0,0,2H17a1,1,0,0,0,0-2Z"/>
        </svg>
...
export const RightAlign = ({classes, ...props}) => {
    return (
        <svg {...props} className={`${classes ?? "fill-gray-400"} small-tiptap-btn tiptap-keyboard-menu-btn`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
export const CenterAlign = ({classes, ...props}) => {
    return (
        <svg {...props} className={`${classes ?? "fill-gray-400"} small-tiptap-btn tiptap-keyboard-menu-btn`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
export const JustifyAlign = ({classes, ...props}) => {
    return (
        <svg {...props} className={`${classes ?? "fill-gray-400"} small-tiptap-btn tiptap-keyboard-menu-btn`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
